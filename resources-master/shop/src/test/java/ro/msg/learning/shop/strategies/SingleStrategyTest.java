...
public class SingleStrategyTest {
	...
	private SingleStrategy singleLocationStrategy;
	...
	public void getStockForProduct() {
		try {
			singleLocationStrategy.algorithmForLocation(Collections.singletonList(orderDetail), stockRepository, locationRepository);
		} catch (Exception e) {
